...
This is a C++ implementation of MA-sLDA for classification with stochastic variational inference. For further details please see the original paper: “Learning supervised topic models from crowds. Rodrigues, F. and Camara, F. and Ribeiro, B. The Third AAAI Conference on Human Computation and Crowdsourcing (HCOMP), 2015.”
...
USAGE: maslda est [data] [answers] [settings] [alpha] [tau] [omega] [k] [random/seeded/model_path] [seed] [batch_size]

EXAMPLE: ./maslda est ../20newsgroups/data_train.txt ../20newsgroups/answers.txt settings.txt 0.1 0.5 1 5 random 1 output 500
...
- “svi delay” and “svi forgetting rate” are the delay and forgetting rate used for estimating the learning rate (rho) in stochastic variational inference.
