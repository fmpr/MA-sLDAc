...
public:
    ...
    ~slda();
    void free_model();
    void init(double alpha_, double tau_, double omega_, int num_topics_, const corpus * c, const settings * setting, double init_seed);
    ...
    double zeta_xi_estimation(suffstats * ss, int eta_update);
