...
This is a C++ implementation of MA-sLDA for classification with maximum likelihood updates for the topics (beta) and the annotators confusion matrices (pi). For further details please see the original paper: “Learning supervised topic models from crowds. Rodrigues, F. and Camara, F. and Ribeiro, B. The Third AAAI Conference on Human Computation and Crowdsourcing (HCOMP), 2015.”
...
USAGE: maslda est [data] [answers] [settings] [alpha] [k] [random/seeded/model_path] [seed]

EXAMPLE: ./maslda est ../20newsgroups/data_train.txt ../20newsgroups/answers.txt settings.txt 0.1 5 random 1 output
