...
struct settings
{
    ...
    int read_settings(char* filename)
    {
        ...
        fscanf(fileptr, "pi laplace smoother %lf\n", &this->PI_LAPLACE_SMOOTHER);
        fscanf(fileptr, "lambda laplace smoother %lf\n", &this->LAMBDA_LAPLACE_SMOOTHER);
        fclose(fileptr);
        ...
        printf("Pi Laplace smoother %f\n", this->PI_LAPLACE_SMOOTHER);
        printf("Lambda Laplace smoother %f\n", this->LAMBDA_LAPLACE_SMOOTHER);
